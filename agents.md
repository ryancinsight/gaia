# gaia — Agent Reference (Hybrid: Current Status + Rewrite Architecture Notes)
...
`gaia` serves as the geometry backbone for millifluidic CFD simulations in the
...
*This document is the architecture reference for the `gaia` rewrite. Implementation
