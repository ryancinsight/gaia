...
//!
//! Demonstrates three profiles swept along +Y using [`gaia::LinearSweep`]:
//!
...
//! Run with:
//! ```sh
//! cargo run -p gaia --example primitives_linear_sweep
//! ```
...
use gaia::domain::geometry::primitives::{linear_sweep::Point2, PrimitiveMesh};
use gaia::infrastructure::io::stl;
use gaia::infrastructure::storage::edge_store::EdgeStore;
use gaia::LinearSweep;
