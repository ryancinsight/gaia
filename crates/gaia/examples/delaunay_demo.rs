...
//! Run with:
//! ```sh
//! cargo run -p gaia --example delaunay_demo
//! ```

use std::fs;
use std::io::BufWriter;

use gaia::application::delaunay::dim2::convert::indexed_mesh::to_indexed_mesh;
use gaia::application::delaunay::{Cdt, Pslg, RuppertRefiner, TriangleQuality};
...
fn compute_quality_stats(
    dt: &gaia::application::delaunay::dim2::triangulation::DelaunayTriangulation,
) -> QualityStats {
